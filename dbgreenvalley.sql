...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `record_total_students` ()   BEGIN
DECLARE totalstudents int;

set totalstudents =(select count(*) from tblstudent);

insert into enrolledstudents_per_year (enrolledstudents_per_year.totalstudents, enrolledstudents_per_year.date) VALUES (totalstudents,NOW());
...
INSERT INTO `changes` (`ID`, `IDNO`, `S_ID`, `fname`, `lastname`, `action`, `created_at`) VALUES
(1, 1323, 123, 'TYTY', 'TYTYTY', 'INSERT', '2023-12-02 11:16:43'),
(2, 1000000203, 0, 'VInce', 'NEill', 'INSERT', '2023-12-02 11:18:40'),
(3, 1000000204, 0, 'a', 'd', 'INSERT', '2023-12-09 10:51:57'),
(4, 1000000205, 0, 'buko', 'juice', 'INSERT', '2023-12-10 13:57:42'),
(5, 1000000206, 0, 'alejo', 'peteros', 'INSERT', '2023-12-12 14:35:34');
...
--
-- Table structure for table `enrolledstudents_per_year`
--

CREATE TABLE `enrolledstudents_per_year` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `enrolledstudents_per_year`
--

INSERT INTO `enrolledstudents_per_year` (`id`, `totalstudents`, `date`) VALUES
(1, 113, '2023-12-09 11:10:17'),
(2, 113, '2023-12-09 11:10:34'),
(3, 113, '2023-12-10 13:52:09'),
(4, 114, '2023-12-12 10:53:01');
...
(0, 1000000202, 146, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000202, 147, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000202, 148, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000202, 149, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000202, 150, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000202, 151, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000202, 152, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000202, 153, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000202, 154, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 100000083, 206, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 100000083, 207, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 100000083, 208, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 100000083, 209, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 100000083, 210, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 100000083, 211, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 100000083, 212, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 100000083, 213, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000205, 206, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000205, 207, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000205, 208, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000205, 209, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000205, 210, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000205, 211, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000205, 212, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000205, 213, 0, 0, 0, 0, 0, 'Failed', '', ''),
(0, 1000000206, 176, 0, 0, 0, 0, 0, '', '', ''),
(0, 1000000206, 177, 0, 0, 0, 0, 0, '', '', ''),
(0, 1000000206, 178, 0, 0, 0, 0, 0, '', '', ''),
(0, 1000000206, 179, 0, 0, 0, 0, 0, '', '', ''),
(0, 1000000206, 180, 0, 0, 0, 0, 0, '', '', ''),
(0, 1000000206, 181, 0, 0, 0, 0, 0, '', '', ''),
(0, 1000000206, 182, 0, 0, 0, 0, 0, '', '', ''),
(0, 1000000206, 345, 0, 0, 0, 0, 0, '', '', '');
...
(0, '2023-2024', 'Second', 30, 1000000202, 'ENROLLED', '2023-11-30 00:00:00', '2023-11-30 00:00:00', 'New'),
(0, '2023-2024', 'Second', 21, 100000083, 'ENROLLED', '2023-12-01 00:00:00', '2023-12-01 00:00:00', 'New'),
(0, '2023-2024', 'Second', 21, 1000000205, 'ENROLLED', '2023-12-10 00:00:00', '2023-12-10 00:00:00', 'New'),
(0, '2023-2024', 'First', 21, 1000000206, 'ENROLLED', '2023-12-12 00:00:00', '2023-12-12 00:00:00', 'New');
...
--
-- Stand-in structure for view `studentsguiduans`
-- (See below for the actual view)
--
CREATE TABLE `studentsguiduans` (
`FNAME` varchar(40)
,`LNAME` varchar(40)
...
(0, 1000000202, 146, 1, 'Second', '2023-2024', 1, 83, 'Passed'),
(0, 1000000202, 147, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000202, 148, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000202, 149, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000202, 150, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000202, 151, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000202, 152, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000202, 153, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000202, 154, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 100000083, 206, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 100000083, 207, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 100000083, 208, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 100000083, 209, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 100000083, 210, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 100000083, 211, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 100000083, 212, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 100000083, 213, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000205, 206, 1, 'Second', '2023-2024', 1, 29.6, 'Failed'),
(0, 1000000205, 207, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000205, 208, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000205, 209, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000205, 210, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000205, 211, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000205, 212, 1, 'Second', '2023-2024', 1, 0, ''),
(0, 1000000205, 213, 1, 'Second', '2023-2024', 1, 0, 'Failed'),
(0, 1000000206, 176, 1, 'First', '2023-2024', 1, 0, ''),
(0, 1000000206, 177, 1, 'First', '2023-2024', 1, 0, ''),
(0, 1000000206, 178, 1, 'First', '2023-2024', 1, 0, ''),
(0, 1000000206, 179, 1, 'First', '2023-2024', 1, 0, ''),
(0, 1000000206, 180, 1, 'First', '2023-2024', 1, 0, ''),
(0, 1000000206, 181, 1, 'First', '2023-2024', 1, 0, ''),
(0, 1000000206, 182, 1, 'First', '2023-2024', 1, 0, ''),
(0, 1000000206, 345, 1, 'First', '2023-2024', 1, 0, '');
...
(0, 'Dominador Solayao Jr.', 'Enterprise Resource Planning', '09493080019'),
(0, 'Emman Flores', 'Database System Management', '09493080019');
...
(0, 1000000202, '2023-11-30 05:59:24', 'Student', 'Logged out'),
(0, 1, '2023-11-30 06:02:01', 'Administrator', 'Logged in'),
(0, 1000000202, '2023-11-30 06:02:57', 'Student', 'Logged in'),
(0, 1, '2023-11-30 07:05:49', 'Administrator', 'Logged out'),
(0, 0, '2023-11-30 07:06:01', 'Administrator', 'Logged in'),
(0, 0, '2023-11-30 07:08:58', 'Administrator', 'Logged in'),
(0, 1, '2023-11-30 07:09:45', 'Administrator', 'Logged in'),
(0, 1, '2023-12-01 14:19:16', 'Administrator', 'Logged in'),
(0, 1, '2023-12-02 03:54:58', 'Administrator', 'Logged in'),
(0, 1000000204, '2023-12-09 03:52:34', 'Student', 'Logged out'),
(0, 1, '2023-12-10 06:59:04', 'Administrator', 'Logged in'),
(0, 1, '2023-12-12 07:24:45', 'Administrator', 'Logged in');
...
(0, '10:00 am', '01:00 pm', '10:00 am-01:00 pm', 'Monday', 'Second', '2023-2024', '303', '3', 33, 175, 0);
...
(0, 'andrew', '', '09518638851', 1000000202),
(0, 'W1323', '', '132313', 1000000203),
(0, 'asd', '', '234', 1000000204),
(0, 'alejo', '', '23456789', 1000000205),
(0, 'fghjkljhgfgdgfhjhgf678976546789', '', '123232', 1000000206);
...
(18, 100000083, 'Josh Bernard', 'Cadelina', 'H', 'Male', '1994-11-22', 'Koronadal City', 'Single', 0, 'Filipino', 'Alliance', '092756633785', 'Koronadal City', 'josh', 'c028c213ed5efcf30c3f4fc7361dbde0c893c5b7', 'New', 1, 1, 21, 'student_image/13406890_1099504936754825_2344921503074981979_n.jpg', 'First', '', 0),
...
(0, 1000000202, 'Cie-jhay', 'Magno', 'Torres', 'Female', '2073-05-06', 'marawi', 'Married', 0, 'filipino', 'inc', '09518638851', '16472', 'cj', '8cb2237d0679ca88db6464eac60da96345513964', 'Irregular', 1, 1, 30, '', 'Second', '', 0),
(123, 1323, 'TYTY', 'TYTYTY', 'WERQ', 'Male', '2023-12-06', 'JKKJK', 'JKJKJK', 12, 'JKJJK', 'JKJK', '1212121', 'DWDADA', '', '', '', 0, 0, 0, '', '', '', 0),
(0, 1000000203, 'VInce', 'NEill', '', 'Female', '2003-02-01', 'SdADWAW', 'Single', 0, '92193792839', '123132', '92193792839', 'awdadawd', 'VINCE', '21cd90d7a25cb79d19bd36e1339054990a4d04d7', 'New', 1, 0, 21, '', 'Second', '', 1),
(0, 1000000204, 'a', 'd', 's', 'Male', '2002-02-03', 'asd', 'Single', 0, 'asd', 'asd', '1221312', 'sadadsadsa', 'we', 'd6ad7802de419c3563a582d8f07586bd2d494458', 'New', 1, 0, 21, '', 'Second', '', 1),
(0, 1000000205, 'buko', 'juice', 'e', 'Female', '2002-02-03', 'marawi', 'Single', 0, '09876543223', 'inc', '09876543223', 'barangay alejo iloveyou 34 street', 'bukojuice', '8ebea98561f17e0f55db1d52ae29cee44b44d48b', 'Irregular', 1, 1, 21, 'student_image/DSC_0536.JPG', 'Second', '', 0),
(0, 1000000206, 'alejo', 'peteros', 'a', 'Female', '1990-09-30', 'wetyrerrytuugfgdfcgjhvgcc', 'Single', 0, '2345432345432234556543215654321565432156', 'nmbvgfgcfhjgfdssngfxd', '2345432345432234556543215654321565432156', '33546rfgfhghfbfffffdrfg', 'alejo', 'e7bde082d09b0aaa610c173939f6b31c63e382be', 'New', 1, 1, 21, '', 'First', '', 0);

--
-- Triggers `tblstudent`
--
DELIMITER $$
CREATE TRIGGER `after_insert_students` AFTER INSERT ON `tblstudent` FOR EACH ROW insert into changes (IDNO,S_ID,fname,lastname,action,created_at) values (new.IDNO,NEW.S_ID,NEW.FNAME,NEW.LNAME,"INSERT", NOW())
$$
DELIMITER ;
...
(1, 'Dexter', 'dexter', '2361da8848a57cde94a8a08019787f95698e0bc7', 'Administrator', 1234, 'photos/LoginRed.jpg'),
(2, 'ciejhay', 'ciejhay', '1c719b38b608e6b991ee4382ad41a471b87c5072', 'Registrar', 0, ''),
(0, 'andrew', 'andrew', '02e0a999c50b1f88df7a8f5a04e1b76b35ea6a88', 'Administrator', 0, ''),
(0, 'angelo', 'angelo', 'd489b904fec03b850597df49e1e32fcdb1a7a7f4', 'Administrator', 0, ''),
(0, 'alejo', 'alejo', 'e3ec0e382dd1ffa21616b750424898a0e5202ac8', 'Registrar', 0, '');

-- --------------------------------------------------------

--
-- Structure for view `studentsguiduans`
--
DROP TABLE IF EXISTS `studentsguiduans`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `studentsguiduans`  AS SELECT `tblstudent`.`FNAME` AS `FNAME`, `tblstudent`.`LNAME` AS `LNAME`, `tblstuddetails`.`GUARDIAN` AS `GUARDIAN` FROM (`tblstudent` join `tblstuddetails` on(`tblstudent`.`IDNO` = `tblstuddetails`.`IDNO`)) ;
...
--
-- Indexes for table `enrolledstudents_per_year`
--
ALTER TABLE `enrolledstudents_per_year`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `enrolledstudents_per_year`
--
ALTER TABLE `enrolledstudents_per_year`
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `record_total_students` ON SCHEDULE EVERY 1 YEAR STARTS '2023-12-12 11:09:11' ON COMPLETION NOT PRESERVE ENABLE DO call record_total_students()$$
